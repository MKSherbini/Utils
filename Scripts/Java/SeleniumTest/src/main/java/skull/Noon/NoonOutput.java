...
public class NoonOutput {
    ...
    public static String renderHtmlOutput(List<NoonDiscount> noonDiscounts) {
        return String.format("  <!doctype html>\n" +
                ...
                "</body>\n" +
                "</html>", renderTable(noonDiscounts));
    }

    private static String renderTable(List<NoonDiscount> noonDiscounts) {
        return String.format("<table class=\"table table-striped table-dark table-hover\">\n" +
                ...
                "%s" +
                "  </tbody>\n" +
                "</table>", noonDiscounts.stream().map(NoonOutput::renderRow).collect(Collectors.joining()));
    }
