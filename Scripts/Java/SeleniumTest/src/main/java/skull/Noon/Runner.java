...
//                .scrap()));
        ...
        scrap("https://www.noon.com/egypt-en/tools-and-home-improvement/daily-deals-eg?limit=200", "tools.html");
    ...
    public static void scrap(String url, String fileName) {
        new Thread(() -> {
            new NoonScrapper(false, url, "D:\\_Temp\\NoonDiscounts\\" + fileName, fileName)
                    .scrap();
        }).start();
    }
}
